...
def random_image_key():
    images = [
        ...
        'static\\images\\chiff1.png',
        'static\\images\\chiff2.jpg',
        'static\\images\\chiff3.jpg',
        'static\\images\\chiff4.png',
        'static\\images\\chiff5.jpg',
        'static\\images\\chiff6.png'
    ]
    return random.SystemRandom().choice(images)
...
class Steganographie:
    ...
    def encode(self, image:str) -> bool:
        ...
        if len(tableau_image) != self.nb_ligne_hote:
            image_o = Image.open(image)
            image_o = image_o.resize((self.nb_colonne_hote,  self.nb_ligne_hote))
            tableau_image =  np.array(image_o)
...
if __name__ == '__main__':
    ...
    my_steg.encode('static\\images\\math-gc81f6134f_1920.jpg')
