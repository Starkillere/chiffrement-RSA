...
if __name__ == '__main__':
    my_rsa = RSA()
    print(my_rsa.chiffrement(122669, 32909, 'saluééééé12'))
    print(my_rsa.dechiffrement(122669, 389, 'QUQYV/Reptemp°YWXQR/Reptemp°SWSXT/Reptemp°TUQ/Reptemp°WXRV/Reptemp°UVSW/Reptemp°QWVTR/Reptemp°TUUQ/Reptemp°P/Reptemp°'))